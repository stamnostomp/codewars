{--
cPete likes to bake some cakes. He has some recipes and ingredients. Unfortunately he is not good in maths. Can you help him to find out, how many cakes he could bake considering his recipes?
...
cakes recipe storage = minimum ratios
  where
    ratios = map calculateRation recipe
    calculateRation (ingredient, needed) =
      let have = fromMaybe 0 (lookup ingredient storage)
       in have `div` needed
